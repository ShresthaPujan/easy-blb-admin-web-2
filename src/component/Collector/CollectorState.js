...
const CollectorState = (props) => {
  ...
  const [collectorBasicFormError, setCollectorBasicFormError] = useState({})
  const [collectorIsSubmit, setCollectorIsSubmit] = useState(false);
  return (
    <collectorContext.Provider
      value={{setCollector,
        ...
        collectorIsSubmit, setCollectorIsSubmit
      }}
    >
      {props.children}
    </collectorContext.Provider>
