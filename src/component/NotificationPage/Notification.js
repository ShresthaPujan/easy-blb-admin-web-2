              ...
              <div className="row">
                ...
                {loading ? (
                  ...
                  <div
                    ...
                    style={{ maxWidth: "100%", overflowX: "auto", marginTop: "10px" }}
                  >
                    <div
                      ...
                      <table className="table table-striped">
                        <thead>
                          <tr className="tableHead">
                            <td className="tc" style={{ width: "10px", textAlign:"left" }}>
                              S.N.
                            </td>
                            <td className="tc" style={{ position: "static", width: "150px", textAlign:"left"}}>Title</td>
                            <td
                              className="tc"
                              style={{ position: "static", width: "150px", textAlign:"left"}}
                            >
                              Description
                            </td>
                            <td
                              className="tc"
                              style={{ position: "static", width: "95px", textAlign:"left"}}
                            >
                              Date
                            </td>
                          </tr>
